...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Jul 23 19:35:18 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BattleCity1.0.0/ && $(COPY_FILE) --parents Blast.h EnemyTank.h MapCollection.h MapElement.h MapMovable.h MapObject.h Missile.h PlayerTank.h Tank.h TankConst.h TankType.h TankWindow.h .tmp/BattleCity1.0.0/ && $(COPY_FILE) --parents resource.qrc .tmp/BattleCity1.0.0/ && $(COPY_FILE) --parents Blast.cpp EnemyTank.cpp main.cpp MapCollection.cpp MapElement.cpp Missile.cpp PlayerTank.cpp Tank.cpp TankWindow.cpp .tmp/BattleCity1.0.0/ && (cd `dirname .tmp/BattleCity1.0.0` && $(TAR) BattleCity1.0.0.tar BattleCity1.0.0 && $(COMPRESS) BattleCity1.0.0.tar) && $(MOVE) `dirname .tmp/BattleCity1.0.0`/BattleCity1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BattleCity1.0.0
