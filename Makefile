...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Jul 22 17:12:34 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/BattleCity1.0.0/ && $(COPY_FILE) --parents Blast.h EnemyTank.h MapElement.h MapMovable.h Missile.h PlayerTank.h Tank.h TankConst.h TankType.h TankWindow.h .tmp/BattleCity1.0.0/ && $(COPY_FILE) --parents resource.qrc .tmp/BattleCity1.0.0/ && $(COPY_FILE) --parents Blast.cpp EnemyTank.cpp main.cpp MapElement.cpp Missile.cpp PlayerTank.cpp Tank.cpp TankWindow.cpp .tmp/BattleCity1.0.0/ && (cd `dirname .tmp/BattleCity1.0.0` && $(TAR) BattleCity1.0.0.tar BattleCity1.0.0 && $(COMPRESS) BattleCity1.0.0.tar) && $(MOVE) `dirname .tmp/BattleCity1.0.0`/BattleCity1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/BattleCity1.0.0
